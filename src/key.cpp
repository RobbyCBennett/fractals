...
const char *to_string(Key key)
{
	switch (key) {
		...
		case KEY_NOTIFICATION_CENTER: return "KEY_NOTIFICATION_CENTER";
		case KEY_PICKUP_PHONE: return "KEY_PICKUP_PHONE";
		case KEY_HANGUP_PHONE: return "KEY_HANGUP_PHONE";
		...
		case KEY_FN_RIGHT_SHIFT: return "KEY_FN_RIGHT_SHIFT";
		...
		case KEY_REFRESH_RATE_TOGGLE: return "KEY_REFRESH_RATE_TOGGLE";
		...
		case KEY_CAMERA_ACCESS_ENABLE: return "KEY_CAMERA_ACCESS_ENABLE";
		case KEY_CAMERA_ACCESS_DISABLE: return "KEY_CAMERA_ACCESS_DISABLE";
		case KEY_CAMERA_ACCESS_TOGGLE: return "KEY_CAMERA_ACCESS_TOGGLE";
		case KEY_ACCESSIBILITY: return "KEY_ACCESSIBILITY";
		case KEY_DO_NOT_DISTURB: return "KEY_DO_NOT_DISTURB";
		...
		case KEY_PRIVACY_SCREEN_TOGGLE: return "KEY_PRIVACY_SCREEN_TOGGLE";

		case KEY_SELECTIVE_SCREENSHOT: return "KEY_SELECTIVE_SCREENSHOT";

		case KEY_NEXT_ELEMENT: return "KEY_NEXT_ELEMENT";
		case KEY_PREVIOUS_ELEMENT: return "KEY_PREVIOUS_ELEMENT";

		case KEY_AUTOPILOT_ENGAGE_TOGGLE: return "KEY_AUTOPILOT_ENGAGE_TOGGLE";

		case KEY_MARK_WAYPOINT: return "KEY_MARK_WAYPOINT";
		case KEY_SOS: return "KEY_SOS";
		case KEY_NAV_CHART: return "KEY_NAV_CHART";
		case KEY_FISHING_CHART: return "KEY_FISHING_CHART";
		case KEY_SINGLE_RANGE_RADAR: return "KEY_SINGLE_RANGE_RADAR";
		case KEY_DUAL_RANGE_RADAR: return "KEY_DUAL_RANGE_RADAR";
		case KEY_RADAR_OVERLAY: return "KEY_RADAR_OVERLAY";
		case KEY_TRADITIONAL_SONAR: return "KEY_TRADITIONAL_SONAR";
		case KEY_CLEARVU_SONAR: return "KEY_CLEARVU_SONAR";
		case KEY_SIDEVU_SONAR: return "KEY_SIDEVU_SONAR";
		case KEY_NAV_INFO: return "KEY_NAV_INFO";
		case KEY_BRIGHTNESS_MENU: return "KEY_BRIGHTNESS_MENU";

		case KEY_MACRO1: return "KEY_MACRO1";
		case KEY_MACRO2: return "KEY_MACRO2";
		case KEY_MACRO3: return "KEY_MACRO3";
		case KEY_MACRO4: return "KEY_MACRO4";
		case KEY_MACRO5: return "KEY_MACRO5";
		case KEY_MACRO6: return "KEY_MACRO6";
		case KEY_MACRO7: return "KEY_MACRO7";
		case KEY_MACRO8: return "KEY_MACRO8";
		case KEY_MACRO9: return "KEY_MACRO9";
		case KEY_MACRO10: return "KEY_MACRO10";
		case KEY_MACRO11: return "KEY_MACRO11";
		case KEY_MACRO12: return "KEY_MACRO12";
		case KEY_MACRO13: return "KEY_MACRO13";
		case KEY_MACRO14: return "KEY_MACRO14";
		case KEY_MACRO15: return "KEY_MACRO15";
		case KEY_MACRO16: return "KEY_MACRO16";
		case KEY_MACRO17: return "KEY_MACRO17";
		case KEY_MACRO18: return "KEY_MACRO18";
		case KEY_MACRO19: return "KEY_MACRO19";
		case KEY_MACRO20: return "KEY_MACRO20";
		case KEY_MACRO21: return "KEY_MACRO21";
		case KEY_MACRO22: return "KEY_MACRO22";
		case KEY_MACRO23: return "KEY_MACRO23";
		case KEY_MACRO24: return "KEY_MACRO24";
		case KEY_MACRO25: return "KEY_MACRO25";
		case KEY_MACRO26: return "KEY_MACRO26";
		case KEY_MACRO27: return "KEY_MACRO27";
		case KEY_MACRO28: return "KEY_MACRO28";
		case KEY_MACRO29: return "KEY_MACRO29";
		case KEY_MACRO30: return "KEY_MACRO30";

		case KEY_MACRO_RECORD_START: return "KEY_MACRO_RECORD_START";
		case KEY_MACRO_RECORD_STOP: return "KEY_MACRO_RECORD_STOP";
		case KEY_MACRO_PRESET_CYCLE: return "KEY_MACRO_PRESET_CYCLE";
		case KEY_MACRO_PRESET1: return "KEY_MACRO_PRESET1";
		case KEY_MACRO_PRESET2: return "KEY_MACRO_PRESET2";
		case KEY_MACRO_PRESET3: return "KEY_MACRO_PRESET3";

		case KEY_KBD_LCD_MENU1: return "KEY_KBD_LCD_MENU1";
		case KEY_KBD_LCD_MENU2: return "KEY_KBD_LCD_MENU2";
		case KEY_KBD_LCD_MENU3: return "KEY_KBD_LCD_MENU3";
		case KEY_KBD_LCD_MENU4: return "KEY_KBD_LCD_MENU4";
		case KEY_KBD_LCD_MENU5: return "KEY_KBD_LCD_MENU5";
